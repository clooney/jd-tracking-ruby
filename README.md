# JD Express Tracking API For Ruby
JD Express Tracking API and webhook make it easy to integrate JD Express Tracking function into your own project. Support APIs Client Libraries for ruby

### API key

In order to use this API, you need to generate a JD Express Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use JD Express Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [JD Express Tracking API](https://www.trackingmore.com/jd-tracking.html)  to:

   *   Get JD Express realtime tracking info of muti-carriers in one integration
   *   Provide JD Express shipment tracking experience like Amazon
   *   Push JD Express notifications of package update with webhook
   *   Verify JD Express delivery exception before it is too late
